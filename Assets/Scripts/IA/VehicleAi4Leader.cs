...
public class VehicleAi4Leader : Vehicle {
    ...
    protected override void Awake() {
        ...
        this.steeringBehaviour.WanderOn(10);

        Vehicle lastVehicle = this;
        for (int i = 0; i < 6; i++) {
            VehicleAi4Follower followerVehicle = Instantiate(follower,transform.position,Quaternion.identity).GetComponent<VehicleAi4Follower>();
